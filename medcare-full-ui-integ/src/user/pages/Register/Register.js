        ...
        <div className="signup-page-container-right">
          ...
          <div className="third-div">
            ...
            <FormControl className="third-div-3" required size="small">
              ...
              >
                <MenuItem value="Male" onChange={(e)=>setgender(e.target.value)}>Male</MenuItem>
                <MenuItem value="Female" onChange={(e)=>setgender(e.target.value)}>Female</MenuItem>
                <MenuItem value="Others" onChange={(e)=>setgender(e.target.value)}>Other</MenuItem>
              </Select>
            </FormControl>
          </div>
          ...
          <Link to='/login'>
            <button className="btn signup-button" onClick={submit}>REGISTER</button>
          </Link>
        </div>
      </div>
    </div>
